...
3. Create `data`, give it mode `700`, and assign it to the image user. For the pinned image that user
   is UID/GID **57439**; verify with `docker run --rm nbs-pywapor:0.3.0 id`.
